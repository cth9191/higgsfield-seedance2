...
All notable changes to `higgsfield-seedance2` are documented in this file.
...
#### Creative Styles
- `01-cinematic` — Film/movie quality with dramatic lighting, camera language
...
- **Production Examples** — 5+ large example prompts per skill (15-25 lines each)
- **Platform Optimization** — Cross-platform guidance (TikTok, Instagram, YouTube, LinkedIn)
